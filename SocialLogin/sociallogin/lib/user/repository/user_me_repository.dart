...
import 'package:sociallogin/user/model/basket_item_model.dart';
import 'package:sociallogin/user/model/patch_basket_body.dart';
...
final userMeRepositoryProvider = Provider<UserMeRepository>(
  (ref) {
    ...
    return UserMeRepository(dio, baseUrl: 'http://$ip/user/current');
  },
);
